...
''' <summary>
''' Partner form providing user interface for the AddArrows class.
''' </summary>
''' <remarks>
''' <para><seealso cref="AddArrows"/></para>
''' <para><seealso cref="AddArrowsForm"/></para></remarks>
<ComVisible(False)> _
