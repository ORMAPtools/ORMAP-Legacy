...
Public Class SpiralDockWindow
    ...
    Public Class AddinImpl
        ...
        Private m_windowUI As SpiralDockWindow

        Protected Overrides Function OnCreateChild() As System.IntPtr
            m_windowUI = New SpiralDockWindow(Me.Hook)
        ...
        End Sub
        Friend ReadOnly Property UI As SpiralDockWindow
            Get
                Return m_windowUI
            End Get
        End Property
