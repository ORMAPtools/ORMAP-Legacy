...
if len(MAP.ListTableViews(MXD, OrmapLayers.CUSTOMDEFINITIONQUERIES_TABLE, mainDF))>0:
    ...
    defQueryCursor = arcpy.SearchCursor(defQueryTable.name, "MapNumber = '" + MapNumber + "'") 
...
if pageLayoutRow==None:
    ...
    mapExtent.XMin = (MapPositionX-1)
    mapExtent.YMin = (MapPositionY-1)
    mapExtent.XMax = (MapPositionX+1)
    mapExtent.YMax = (MapPositionY+1)
