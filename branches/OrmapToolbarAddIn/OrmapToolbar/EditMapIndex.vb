...
#Region "Event Handlers"
    ...
    Private Sub PartnerMapIndexForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles _partnerEditMapIndexForm.Load
        ...
        EditingState = (My.ArcMap.Editor.EditState = esriEditState.esriStateEditing)
    ...
    Private Sub uxSuffixType_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If PartnerEditMapIndexForm.uxSuffixType.Text <> String.Empty Then
            _ormapNumber.SuffixType = ConvertCodeValueDomainToCode(DataMonitor.TaxlotFeatureLayer.FeatureClass.Fields, OrmapExtension.TaxLotSettings.MapSuffixTypeField, PartnerEditMapIndexForm.uxSuffixType.Text)
        End If
        If _ormapNumber.IsValidNumber Then
...
#Region "Methods"
    ...
    Friend Sub DoButtonOperation()
        ...
        Try
            ...
            Else
                ...
                'theEnumFeature = OrmapExtension.Editor.EditSelection
                Dim theMxDoc As IMxDocument
                Dim theMap As IMap
                theMxDoc = DirectCast(My.ArcMap.Application.Document, IMxDocument)
    ...
    Private Sub editMapIndex(ByRef theEditWorkSpace As IWorkspaceEdit)
        ...
        Try
            ...
            With PartnerEditMapIndexForm
                ...
                ' Set Reliability
                Dim value As String = ConvertCodeValueDomainToCode(_mapIndexFeature.Fields, OrmapExtension.MapIndexSettings.ReliabilityCodeField, .uxReliability.Text)
                ...
                ' Set MapScale
                value = ConvertCodeValueDomainToCode(_mapIndexFeature.Fields, OrmapExtension.MapIndexSettings.MapScaleField, .uxScale.Text)
                If Integer.TryParse(value, valueAsInteger) Then
            ...
            ' Finalize this edit
            My.ArcMap.Editor.StopOperation("Edit Map Index")
        ...
        Catch ex As Exception
            ...
            My.ArcMap.Application.StatusBar.Message(esriStatusBarPanes.esriStatusMain) = "MapIndex feature update aborted"
    ...
    Private Sub initializeFieldIndices()
        ...
        With _mapIndexFields
            .ORMAPNumber = mapindexFC.FindField(OrmapExtension.MapIndexSettings.OrmapMapNumberField)
            .Reliability = mapindexFC.FindField(OrmapExtension.MapIndexSettings.ReliabilityCodeField)
            .MapScale = mapindexFC.FindField(OrmapExtension.MapIndexSettings.MapScaleField)
            .MapNumber = mapindexFC.FindField(OrmapExtension.MapIndexSettings.MapNumberField)
            .Page = mapindexFC.FindField(OrmapExtension.MapIndexSettings.PageNumberField)
        End With

        With _taxlotFields
            .Taxlot = taxlotFC.FindField(OrmapExtension.TaxLotSettings.TaxlotField)
            .Anomaly = taxlotFC.FindField(OrmapExtension.TaxLotSettings.AnomalyField)
            .County = taxlotFC.FindField(OrmapExtension.TaxLotSettings.CountyField)
            .MapNumber = taxlotFC.FindField(OrmapExtension.TaxLotSettings.MapNumberField)
            .OrmapMapNumber = taxlotFC.FindField(OrmapExtension.TaxLotSettings.OrmapMapNumberField)
            .OrmapTaxlotNumber = taxlotFC.FindField(OrmapExtension.TaxLotSettings.OrmapTaxlotField)
            .MapTaxlotNumber = taxlotFC.FindField(OrmapExtension.TaxLotSettings.MapTaxlotField)
            .PartialRangeCode = taxlotFC.FindField(OrmapExtension.TaxLotSettings.RangePartField)
            .PartialTownshipCode = taxlotFC.FindField(OrmapExtension.TaxLotSettings.TownshipPartField)
            .Quarter = taxlotFC.FindField(OrmapExtension.TaxLotSettings.QuarterSectionField)
            .QuarterQuarter = taxlotFC.FindField(OrmapExtension.TaxLotSettings.QuarterQuarterSectionField)
            .Range = taxlotFC.FindField(OrmapExtension.TaxLotSettings.RangeField)
            .RangeDirectional = taxlotFC.FindField(OrmapExtension.TaxLotSettings.RangeDirectionField)
            .Section = taxlotFC.FindField(OrmapExtension.TaxLotSettings.SectionNumberField)
            .SuffixNumber = taxlotFC.FindField(OrmapExtension.TaxLotSettings.MapSuffixNumberField)
            .SuffixType = taxlotFC.FindField(OrmapExtension.TaxLotSettings.MapSuffixTypeField)
            .Township = taxlotFC.FindField(OrmapExtension.TaxLotSettings.TownshipField)
            .TownshipDirectional = taxlotFC.FindField(OrmapExtension.TaxLotSettings.TownshipDirectionField)
        End With
    ...
    Private Sub initForm()
        ...
        _ormapNumber.ParseNumber(ReadValue(theRow, OrmapExtension.MapIndexSettings.OrmapMapNumberField))
    ...
    Private Function initEmpty() As Boolean
        Try
            _ormapNumber = New ORMapNum
            With _ormapNumber
                .County = Integer.Parse(OrmapExtension.DefaultValuesSettings.County).ToString
                .Township = String.Empty
                .TownshipDirectional = OrmapExtension.DefaultValuesSettings.TownshipDirection
                .PartialTownshipCode = OrmapExtension.DefaultValuesSettings.TownshipPart
                .Range = String.Empty
                .RangeDirectional = OrmapExtension.DefaultValuesSettings.RangeDirection
                .PartialRangeCode = OrmapExtension.DefaultValuesSettings.RangePart
                .Section = String.Empty
                .Quarter = OrmapExtension.DefaultValuesSettings.QuarterSection
                .QuarterQuarter = OrmapExtension.DefaultValuesSettings.QuarterQuarterSection
                .SuffixNumber = OrmapExtension.DefaultValuesSettings.MapSuffixNumber
                .SuffixType = OrmapExtension.DefaultValuesSettings.MapSuffixType
                .Anomaly = OrmapExtension.DefaultValuesSettings.Anomaly
            End With
            ...
            With PartnerEditMapIndexForm
                ...
                ' Townships
                AddCodesToCombo(OrmapExtension.TaxLotSettings.TownshipField, DataMonitor.TaxlotFeatureLayer.FeatureClass, .uxTownship, _ormapNumber.Township, True)
                ' Township directionals
                AddCodesToCombo(OrmapExtension.TaxLotSettings.TownshipDirectionField, DataMonitor.TaxlotFeatureLayer.FeatureClass, .uxTownshipDirectional, _ormapNumber.TownshipDirectional, True)
                ' Partial township codes
                AddCodesToCombo(OrmapExtension.TaxLotSettings.TownshipPartField, DataMonitor.TaxlotFeatureLayer.FeatureClass, .uxTownshipPartial, ConvertCodeValueDomainToDescription(DataMonitor.TaxlotFeatureLayer.FeatureClass.Fields, OrmapExtension.TaxLotSettings.TownshipPartField, _ormapNumber.PartialTownshipCode), True)

                ' Ranges
                AddCodesToCombo(OrmapExtension.TaxLotSettings.RangeField, DataMonitor.TaxlotFeatureLayer.FeatureClass, .uxRange, _ormapNumber.Range, True)
                ' Range directionals
                AddCodesToCombo(OrmapExtension.TaxLotSettings.RangeDirectionField, DataMonitor.TaxlotFeatureLayer.FeatureClass, .uxRangeDirectional, _ormapNumber.RangeDirectional, True)
                ' Partial range codes
                AddCodesToCombo(OrmapExtension.TaxLotSettings.RangePartField, DataMonitor.TaxlotFeatureLayer.FeatureClass, .uxRangePartial, ConvertCodeValueDomainToDescription(DataMonitor.TaxlotFeatureLayer.FeatureClass.Fields, OrmapExtension.TaxLotSettings.RangePartField, _ormapNumber.PartialRangeCode), True)

                ' Sections
                AddCodesToCombo(OrmapExtension.TaxLotSettings.SectionNumberField, DataMonitor.TaxlotFeatureLayer.FeatureClass, .uxSection, _ormapNumber.Section, True)
                ' Quarters
                AddCodesToCombo(OrmapExtension.TaxLotSettings.QuarterSectionField, DataMonitor.TaxlotFeatureLayer.FeatureClass, .uxSectionQuarter, _ormapNumber.Quarter, True)
                ' Quarters of quarter
                AddCodesToCombo(OrmapExtension.TaxLotSettings.QuarterQuarterSectionField, DataMonitor.TaxlotFeatureLayer.FeatureClass, .uxSectionQtrQtr, _ormapNumber.QuarterQuarter, True)

                ' Counties
                AddCodesToCombo(OrmapExtension.TaxLotSettings.CountyField, DataMonitor.TaxlotFeatureLayer.FeatureClass, .uxCounty, ConvertCodeValueDomainToDescription(DataMonitor.TaxlotFeatureLayer.FeatureClass.Fields, OrmapExtension.TaxLotSettings.CountyField, Integer.Parse(_ormapNumber.County).ToString), True)
                ' Suffix number
                .uxSuffixNumber.Text = _ormapNumber.SuffixNumber
                ' Suffix types
                AddCodesToCombo(OrmapExtension.TaxLotSettings.MapSuffixTypeField, DataMonitor.TaxlotFeatureLayer.FeatureClass, .uxSuffixType, _ormapNumber.SuffixType, True)
                ' Reliabilities
                AddCodesToCombo(OrmapExtension.MapIndexSettings.ReliabilityCodeField, DataMonitor.MapIndexFeatureLayer.FeatureClass, .uxReliability, String.Empty, True)
                ' Scales
                AddCodesToCombo(OrmapExtension.MapIndexSettings.MapScaleField, DataMonitor.MapIndexFeatureLayer.FeatureClass, .uxScale, String.Empty, True)
                ' Anomaly
    ...
    Private Function initWithFeature(ByVal feature As IFeature) As Boolean
        Try
            ...
            With PartnerEditMapIndexForm
                ...
                AddCodesToCombo(OrmapExtension.TaxLotSettings.TownshipDirectionField, DataMonitor.TaxlotFeatureLayer.FeatureClass, .uxTownshipDirectional, _ormapNumber.TownshipDirectional, True)
                ' Partial township codes
                AddCodesToCombo(OrmapExtension.TaxLotSettings.TownshipPartField, DataMonitor.TaxlotFeatureLayer.FeatureClass, .uxTownshipPartial, "0" & _ormapNumber.PartialTownshipCode, True)

                ' Ranges
                AddCodesToCombo(OrmapExtension.TaxLotSettings.RangeField, DataMonitor.TaxlotFeatureLayer.FeatureClass, .uxRange, _ormapNumber.Range, True)
                ' Partial range codes
                AddCodesToCombo(OrmapExtension.TaxLotSettings.RangePartField, DataMonitor.TaxlotFeatureLayer.FeatureClass, .uxRangePartial, "0" & _ormapNumber.PartialRangeCode, True)
                ' Range directionals
                AddCodesToCombo(OrmapExtension.TaxLotSettings.RangeDirectionField, DataMonitor.TaxlotFeatureLayer.FeatureClass, .uxRangeDirectional, _ormapNumber.RangeDirectional, True)
                ...
                ' Counties
                AddCodesToCombo(OrmapExtension.MapIndexSettings.CountyField, DataMonitor.TaxlotFeatureLayer.FeatureClass, .uxCounty, ConvertCodeValueDomainToDescription(DataMonitor.TaxlotFeatureLayer.FeatureClass.Fields, OrmapExtension.TaxLotSettings.CountyField, Integer.Parse(_ormapNumber.County).ToString), True)
                ' Suffix number
                .uxSuffixNumber.Text = _ormapNumber.SuffixNumber
                ' Suffix types
                AddCodesToCombo(OrmapExtension.TaxLotSettings.MapSuffixTypeField, DataMonitor.TaxlotFeatureLayer.FeatureClass, .uxSuffixType, ConvertCodeValueDomainToDescription(DataMonitor.TaxlotFeatureLayer.FeatureClass.Fields, OrmapExtension.TaxLotSettings.MapSuffixTypeField, _ormapNumber.SuffixType), True)
                ' Reliabilities
                AddCodesToCombo(OrmapExtension.MapIndexSettings.ReliabilityCodeField, DataMonitor.MapIndexFeatureLayer.FeatureClass, .uxReliability, ReadValue(thisRow, OrmapExtension.MapIndexSettings.ReliabilityCodeField), True)
                ' Scales
                AddCodesToCombo(OrmapExtension.MapIndexSettings.MapScaleField, DataMonitor.MapIndexFeatureLayer.FeatureClass, .uxScale, ReadValue(thisRow, OrmapExtension.MapIndexSettings.MapScaleField), True)
                ' Page
                .uxPage.Text = ReadValue(thisRow, OrmapExtension.MapIndexSettings.PageNumberField)
                ' Anomaly
                .uxAnomaly.Text = _ormapNumber.Anomaly

                ' Preview
                .uxMapNumber.Text = ReadValue(thisRow, OrmapExtension.MapIndexSettings.MapNumberField)
    ...
    Private Sub updateTaxlots(ByVal theMapIndexFeature As IFeature)
        Try
            My.ArcMap.Application.StatusBar.Message(esriStatusBarPanes.esriStatusMain) = "Finding underlying Taxlot features..."
            ...
            Do While thisTaxlotFeature IsNot Nothing
                ...
                My.ArcMap.Application.StatusBar.Message(esriStatusBarPanes.esriStatusMain) = "Updating underlying Taxlot " & CStr(thisTaxlotFeature.Value(_taxlotFields.Taxlot))
                ...
                'Dim countyCode As Short = CShort(OrmapExtension.DefaultValuesSettings.County)
                'Dim mapTaxlotValue As String = String.Empty
                'Dim taxlotAsInteger As Integer = 0

                'Select Case countyCode
                '    Case 1 To 19, 21 To 36
                '        mapTaxlotValue = GenerateMapTaxlotValue(mapTaxlotID, OrmapExtension.TaxLotSettings.MapTaxlotFormatMask)
                '    Case 20
            ...
            My.ArcMap.Application.StatusBar.Message(esriStatusBarPanes.esriStatusMain) = "Underlying taxlot features updated"
        ...
        Catch ex As Exception
            My.ArcMap.Application.StatusBar.Message(esriStatusBarPanes.esriStatusMain) = String.Empty
            Throw
...
#Region "State Machine"
    ...
    Private Sub CondState1()
        ...
        If _ormapNumber.IsValidNumber AndAlso _
                My.ArcMap.Editor.EditState = esriEditState.esriStateEditing Then 'AndAlso _
