...
#Region "Event Handlers"
    ...
    ''' <summary>
    ''' Selects all the checkboxes on the uxDefQueryLayers Checkboxlist
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub uxDefQuerySelectAll_Click(sender As System.Object, e As System.EventArgs) Handles uxDefQuerySelectAll.Click
        For i As Integer = 0 To uxDefQueryLayers.Items.Count - 1
            uxDefQueryLayers.SetItemChecked(i, True)
        Next
    End Sub

    ''' <summary>
    ''' Clears all the checkboxes on the uxDefQueryLayers Checkboxlist
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub uxDefQueryClearAll_Click(sender As System.Object, e As System.EventArgs) Handles uxDefQueryClearAll.Click
        For i As Integer = 0 To uxDefQueryLayers.Items.Count - 1
            uxDefQueryLayers.SetItemChecked(i, False)
        Next
    End Sub

    ''' <summary>
    ''' Switches the selction on all the checkboxes on the uxDefQueryLayers Checkboxlist
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub uxDefQuerySwitchSelection_Click(sender As System.Object, e As System.EventArgs) Handles uxDefQuerySwitchSelection.Click
        For i As Integer = 0 To uxDefQueryLayers.Items.Count - 1
            uxDefQueryLayers.SetItemChecked(i, Not uxDefQueryLayers.GetItemChecked(i))
        Next
    End Sub
...
#Region "Methods"
    ...
    Friend Sub ImportSettings(Optional theSourceFilePath As String = "", Optional ByRef checkSuccess As Boolean = False)
        ...
        ' Create a back up of this file if it exists
    ...
    Private Sub SetBindings()
        ...
        TableNamesSettingsBindingSource.DataSource = OrmapExtension.TableNamesSettings
        AnnoTableNamesSettingsBindingSource.DataSource = OrmapExtension.AnnoTableNamesSettings
        AllTablesSettingsBindingSource.DataSource = OrmapExtension.AllTablesSettings
        MapIndexSettingsBindingSource.DataSource = OrmapExtension.MapIndexSettings
        TaxLotSettingsBindingSource.DataSource = OrmapExtension.TaxLotSettings
        TaxLotLinesSettingsBindingSource.DataSource = OrmapExtension.TaxLotLinesSettings
        CartographicLinesSettingsBindingSource.DataSource = OrmapExtension.CartographicLinesSettings
        TaxlotAcreageAnnoSettingsBindingSource.DataSource = OrmapExtension.TaxlotAcreageAnnoSettings
        TaxlotNumberAnnoSettingsBindingSource.DataSource = OrmapExtension.TaxlotNumberAnnoSettings
        DefaultValuesSettingsBindingSource.DataSource = OrmapExtension.DefaultValuesSettings
