...
#Region "Constructors"
    ...
    Public Sub New()
        ...
        'MyBase.m_caption = "Move Down Wide Space"   'localizable text 
        'MyBase.m_message = "Moves selected annotation set down and inserts wide space"   'localizable text 
        'MyBase.m_toolTip = "Move down && insert wide space" 'localizable text 
        'MyBase.m_name = "_WideBothSidesDown"  'unique id, non-localizable (e.g. "MyCategory_ArcMapCommand")
