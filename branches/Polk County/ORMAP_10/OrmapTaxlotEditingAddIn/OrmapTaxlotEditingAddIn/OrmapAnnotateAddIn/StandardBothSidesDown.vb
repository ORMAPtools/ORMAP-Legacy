...
#Region "Constructors"
    ...
    Public Sub New()
        ...
        'MyBase.m_caption = "Move Down Standard Space"   'localizable text 
        'MyBase.m_message = "Moves selected annotation down and inserts standard space"   'localizable text 
        'MyBase.m_toolTip = "Move down && insert standard space" 'localizable text 
        'MyBase.m_name = "_StandardBothSidesDown"  'unique id, non-localizable (e.g. "MyCategory_ArcMapCommand")
    ...
    Friend Sub DoButtonOperation()
        ...
        Try
            ...
            If Not DataMonitor.HasValidMapIndexData Then
                ...
                Exit Sub
            End If
            AnnotationUtilities.MoveAnnotationElements(False, False, False, True, True, False)
        Catch ex As Exception
