...
#Region "Methods"
    ...
    Friend Sub ApplyTheDefinitionQuery(ByRef QueryString As String)
        ...
        'Option 1: preferable option.  Need to check to see if there is a way to identify anno subclass.
        '          This is causing problems with applying the definition query
