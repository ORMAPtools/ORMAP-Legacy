...
<ComClass(StandardBothSidesUp.ClassId, StandardBothSidesUp.InterfaceId, StandardBothSidesUp.EventsId), _
 ProgId("OrmapTaxlotEditing.StandardBothSidesUp")> _
    ...
    Friend Sub DoButtonOperation()
        ...
        Try
            ...
            If Not HasValidMapIndexData Then
                ...
                Exit Sub
            End If
            MoveAnnotationElements(False, False, True, False, True, False)
        Catch ex As Exception
...
#Region "COM GUIDs"
    ...
    Public Const ClassId As String = "014fab9e-c40d-437f-9862-2791e1dd89d5"
    Public Const InterfaceId As String = "287879f9-f88d-4374-b19b-e2e57d6e4cda"
    Public Const EventsId As String = "2c73838c-6147-403d-b7e4-d69a92c614c0"
#End Region
