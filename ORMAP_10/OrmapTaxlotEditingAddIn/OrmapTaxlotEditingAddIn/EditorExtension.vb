...
Imports OrmapTaxlotEditingAddIn.StringUtilities
...
#Region "Methods"
    ...
    Private Shared Sub addTraceListenerForEventLog()
        ...
        Dim theTraceListener As EventLogTraceListener = New EventLogTraceListener(DirectCast(Application.Info.ProductName, String))
        theTraceListener.Name = Application.Info.AssemblyName & "_EventLogTraceListener"
    ...
    Private Shared Sub addTraceListenerForFileLog(ByVal inLogFileName As String)
        ...
        theTextListener.Name = Application.Info.AssemblyName & "_FileLogTraceListener"
    ...
    Private Shared Sub removeTraceListenerForEventLog()
        ...
        Dim theTraceListenerName As String = Application.Info.AssemblyName & "_EventLogTraceListener"
    ...
    Private Shared Sub removeTraceListenerForFileLog()
        ' Find the trace listener.
        Dim theTraceListenerName As String = Application.Info.AssemblyName & "_FileLogTraceListener"
    ...
    Public Sub Startup(ByRef initializationData As Object) Implements ESRI.ArcGIS.esriSystem.IExtension.Startup
        ...
        Try
            If Not initializationData Is Nothing AndAlso TypeOf initializationData Is IEditor2 Then
                ...
                addTraceListenerForFileLog(Application.Info.DirectoryPath & "\" & Application.Info.AssemblyName & ".trace.log")
